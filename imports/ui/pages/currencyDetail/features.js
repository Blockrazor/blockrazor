...
Template.features.onCreated(function() {
    ...
    this.autorun(() => {
        ...
        this.featuresShow.set(Features.find(query, {
            limit: this.featureLimit.get(),
            sort: {
                rating: -1,
                appealNumber: -1,
                createdAt: -1
        ...
        //prefetch
        Features.find(query, {
            limit: this.featureLimit.get() + this.featureIncrement,
            sort: {
                rating: -1,
                createdAt: -1,
                appealNumber: -1
...
Template.features.events({
    ...
    'click #name': function() {
        if (Template.instance().lastId.get()) {
            document.getElementById(Template.instance().lastId.get()).style.display = "none";
        }
